...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>List of Archived Students</h1>
          </div>
          <div class="col-sm-6">
        ...
        ?>
           <tr>
                ...
                <td>
                    ...
                    <a href="edit_student.php?id=<?= $student['Student_ID']; ?>" class="btn btn-success">Update</a>
                    <a href="delete_student.php?id=<?= $student['Student_ID']; ?>" class="btn btn-danger">Unarchive</a>
                </td>
            </tr>
            <?php
            }
