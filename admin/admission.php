...
if (isset($_POST['save'])) {
  ...
  $scholastic = mysqli_real_escape_string($conn, $_POST['scholastic']);
  $status = "Active";


  $query = "INSERT INTO student (Student_Lastname,Student_Firstname,Student_Middlename,Student_Birthdate,Student_Gender,
    Student_Email,Student_Username,Student_Password,Student_Phone,Student_Program,Scholarship_Status,Scholastic_Status,Student_Year_Level,country,zip,province,city,barangay,purok,street,Status) 
    VALUES ('$lastname','$firstname',' $middlename','$birth','$gender',' $email','$username',md5('$password'),'$phone','$program','$scholastic','$scholarship','$year','$country','$zip','$province','$city','$brgy','$street','$purok','$status')";
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="lastname" id="lastname" placeholder="Enter Last Name" required autocapitalize="words">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="firstname">First Name</label>
                          <input type="text" class="form-control" name="firstname" id="firstname" placeholder="Enter First Name" required autocapitalize="words">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="middlename">Middle Name</label>
                          <input type="text" class="form-control" name="middlename" id="middlename" placeholder="Enter Middle Name" required aautocapitalize="words">
                        </div>
                      </div>
                      <div class="col-md-4">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" name="" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="11" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input class="form-control" id="scholastic" name="scholastic" value="Regular" required>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="scholarship">Scholarship Status</label>
                          <input class="form-control" id="scholarship" name="scholarship" value="Paying" required>
                        </div>
                      </div>
                    </div>
                    <hr>
