...
include ('includes/db_connection.php');
    ...
    $query_college = "SELECT * FROM department WHERE College_Name='$college'";
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>List of Departments in CCS</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">Deparment Management</li>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <?php 
        $query = "SELECT * FROM department WHERE College_Name = 'COLLEGE OF COMPUTER STUDIES'";
        $query_run = mysqli_query($conn, $query);
